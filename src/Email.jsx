...
const Email = () => {
  return (
    <div className="relative bg-purple-50 flex flex-col items-center justify-center w-[90%] lg:w-300 mt-40 lg:mt-0 mb-40 lg:h-90 mx-auto rounded-tl-[150px] rounded-2xl ">
      <img src={sendImg} alt="" className="absolute top-[-20px] right-[-20px]"/>
